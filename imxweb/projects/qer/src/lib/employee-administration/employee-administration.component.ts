...
import { IdentitiesReportsService } from '../identities/identities-reports.service';
import { IdentitiesService } from '../identities/identities.service';
import { IdentitySidesheetComponent } from '../identities/identity-sidesheet/identity-sidesheet.component';


@Component({
    selector: 'itd-employee-administration',
  ...
  private async init(): Promise<void> {
    ...
    console.warn("Entity schema", this.entitySchemaPersonReports.Columns);
    try {
  ...
  private async navigate(): Promise<void> {
    ...
    try {
      ...
      this.dstSettings = {
        ...
        filters: undefined, // so that no filter is applied
